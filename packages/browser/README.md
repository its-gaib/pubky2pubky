...
Browser transport for pubky2pubky v4. It uses a Pubky 0.11 Ring Grant restricted to
...
`peer-verified` event is emitted only after the v4 client returns a mutually verified relay peer.
